          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              <h1 className="mb-8 text-balance text-5xl tracking-tight text-white [text-shadow:_0_4px_20px_rgb(0_0_0_/_60%)] md:text-6xl lg:text-8xl">
                <span className="font-open-sans-custom not-italic">Понять.</span>{" "}
                <span className="font-serif italic">Принять.</span>{" "}
                <span className="font-open-sans-custom not-italic">Действовать.</span>
              </h1>
              ...
              <p className="mb-8 mx-auto max-w-2xl text-pretty leading-relaxed text-gray-300 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-thin font-open-sans-custom tracking-wide leading-7 text-xl">
                студент, педагог или специалист — изучи принципы инклюзии,{" "}
                <span className="font-serif italic">освой</span> этикет общения и создай пространство, где каждый чувствует себя своим
              </p>

              <div className="flex justify-center">
                <ShinyButton className="px-8 py-3 text-base">начать обучение</ShinyButton>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Выберите подходящий формат — от самостоятельного изучения до корпоративных программ для организаций.
              </p>
            </div>
            <BentoPricing />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Наша миссия — сделать инклюзивную культуру доступной и понятной для каждого.
              </p>
            </div>
            <AboutQuote />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl mt-[5vh]">
            <ContactCard
              ...
              description="Есть вопросы о курсах, материалах или инклюзивной практике? Напишите нам — ответим в течение 1 рабочего дня."
              contactInfo={[
                {
                  icon: MailIcon,
                  label: "Почта",
                  value: "hello@inklusivmir.ru",
                },
                {
                  icon: PhoneIcon,
                  label: "Телефон",

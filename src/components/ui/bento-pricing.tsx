  ...
  return (
    <div className="grid grid-cols-1 gap-1.5 md:grid-cols-2 lg:grid-cols-8">
      ...
      >
        ...
        <div className="flex flex-col p-3 lg:flex-row">
          ...
          <ul className="text-gray-300 grid gap-2 text-xs lg:w-[70%] font-open-sans-custom">
            {[
              "Обучение всей команды или отдела",
              "Адаптация программы под специфику организации",
              "Сертификаты для сотрудников по итогам курса",
              "Поддержка куратора на всём пути обучения",
            ].map((f, i) => (
              <li key={i} className="flex items-center gap-2">
                <Check className="w-[1.05rem] h-[1.05rem] text-white flex-shrink-0" strokeWidth={3} />
      ...
      <PricingCard
        ...
        features={[
          "Базовые материалы по этикету инклюзии",
          "Словарь корректной терминологии",
          "Вводный тест на знание принципов",
          "Доступ к сообществу платформы",
        ]}
      ...
      <PricingCard
        titleBadge="ДЛЯ СТУДЕНТОВ"
        priceLabel="990 ₽"
        priceSuffix="/мес"
        features={[
          "Полный курс «Этикет инклюзивной культуры»",
          "Интерактивные задания и кейсы",
      ...
      <PricingCard
        titleBadge="ДЛЯ ПЕДАГОГОВ"
        priceLabel="1 990 ₽"
        priceSuffix="/мес"
        features={["Методические материалы для занятий", "Готовые сценарии уроков по инклюзии", "Консультации эксперта"]}
        className="lg:col-span-4"
        cta="Записаться"
      />
      ...
      <PricingCard
        ...
        features={[
          ...
          "Работа с экспертом один на один",

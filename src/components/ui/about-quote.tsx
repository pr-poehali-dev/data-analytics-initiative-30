        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы верим, что инклюзивная культура — это не набор правил, а способ мышления. Наша платформа помогает студентам, педагогам и специалистам освоить этику общения с людьми с ОВЗ через практику, а не только теорию.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Студент, изучающий социальную работу, HR-специалист или руководитель организации — каждый найдёт здесь знания и инструменты, чтобы сделать своё окружение по-настоящему открытым для всех.
            </p>
          </div>
        </div>
      </div>
